...
if __name__ == '__main__':
    ...
    for episode in range(EPISODES):
        ...
        while not game_over and steps_since_food <= MAX_STEPS_SINCE_FOOD:
            ...
            snake.dql_update(food_loc=food.rect, window_width=WINDOW_WIDTH, window_height=WINDOW_HEIGHT)
            ...
            snake.update_replay_buffer(state_vector=state_vector, reward=reward)
